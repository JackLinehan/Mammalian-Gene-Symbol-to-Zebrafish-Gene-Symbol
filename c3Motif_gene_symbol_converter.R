...
hallmark_set = scan('C2_subcollection_Canonical_Pathway.txt', what = 'list')
...
##############################################################################################
## GO with this method to write data to file 


sink('C:/Users/JLinehan/Documents/RCodes/Gene_set_enrichment_analysis/test_c2_writer.txt')
#sink("/Users/jack/Desktop/drerio_c3_motif.txt")
writeLines(unlist(lapply(drerio_gene_symbol, paste, collapse=" ")))
sink()
